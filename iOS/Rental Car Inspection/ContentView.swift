...
struct ContentView: View {
    ...
    @State private var editingItem: Inspection?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Rental Car Inspection")
            .toolbar {
    ...
    private func editSheet(for item: Inspection) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: Inspection
    var onSave: (Inspection) -> Void
    var onDelete: () -> Void
